...
public class BoardManager : MonoBehaviour
{
    ...
    void GenerateFood()
    {
        int foodCount = Random.Range(foodCountMin, foodCountMax+1);
        int tipoComida = 0;
        ...
        for (int i = 0; i < foodCount; ++i)
        {
            ...
            CellData data = m_BoardData[coord.x, coord.y];
            tipoComida = Random.Range(0, FoodPrefab.Length);
            FoodObject newFood = Instantiate(FoodPrefab[tipoComida]);
    ...
    void GenerateWall()
    {
        ...
        {
            int wallRandom = Random.Range(0, WallPrefab.Length);
            int randomIndex = Random.Range(0, m_EmptyCellsList.Count);
            Vector2Int coord = m_EmptyCellsList[randomIndex];

            m_EmptyCellsList.RemoveAt(randomIndex);
            CellData data = m_BoardData[coord.x, coord.y];
            WallObject newWall = Instantiate(WallPrefab[wallRandom]);
